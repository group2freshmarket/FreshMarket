...
//		}
	...
	public ModelAndView addItems(@RequestParam("itemName") String itemName, @RequestParam("itemType") String itemType,
			@RequestParam("itemImage") MultipartFile itemImage, @RequestParam("itemCount") int itemCount,
...
// @RequestMapping("/deleteItem")
	...
	public Item addData(String itemName, String itemType, int itemCount, double itemPrice, MultipartFile itemImage,
			String itemDesc) {
